    ...
    <header>
        ...
        <div class="sidebar-fixed position-fixed">
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="staff_exeat_assign.php" class="list-group-item list-group-item-action active waves-effect">
                    <i class="fas fa-user mr-3"></i>Assign Exeat</a>
                <a href="staff_exeat_manage.php" class="list-group-item list-group-item-action waves-effect">
