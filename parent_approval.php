    ...
    <header>
            ...
            <div class="container-fluid">
                ...
                <a class="navbar-brand waves-effect" href="#">
                    <strong class="blue-text">
                        <marquee>Welcome: <?php echo $parentlogin;?></marquee>
                    </strong>
                </a>
        ...
        <div class="sidebar-fixed position-fixed">
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="parent_approval.php" class="list-group-item active list-group-item-action waves-effect">
                    <i class="fas fa-table mr-3"></i>Parent Approval</a>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" id="exeat_approve" name="exeat_approve"
                                        value="<?php echo $parentlogin;?>" disabled>
                                    <small id="infostudentForm" class="form-text"></small>
                                </div>
                            </div>
                ...
                <div class="col-md-5 mb-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <?php 
                                $manageExeatDateShow = '';
                                $manageExeatDateSQL = "SELECT * FROM exeat WHERE s_id = '$studentlogin' AND status_ = 'Not Returned'  ORDER BY assign_date DESC";
